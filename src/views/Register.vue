<template>
  <div class="registerPage">
    ...
    <form @submit.prevent="registerAndRedirect">
      <div>
        <input type="text" placeholder="First name" class="form-control registerInput" v-model="credentials.first_name" required>
      </div>
      <div>
        <input type="text" placeholder="Last name" class="form-control registerInput" v-model="credentials.last_name" required>
      </div>
      <div>
        <input type="email" placeholder="Email" class="form-control registerInput" v-model="credentials.email" required>
      </div>
      <div>
        <input type="password" name="password" placeholder="Password" class="form-control registerInput" v-model="credentials.password" required>
      </div>
      <div>
